...
awk '{gsub(/<LAPI_CONTAINER_IMAGE>/,"gcr.io/'$2'/'$1':'$5'")}1' /workspace/service.yaml >/workspace/tmp.yaml && mv /workspace/tmp.yaml /workspace/service.yaml
...
awk '{gsub(/<LAPI_SA>/,"'$8'")}1' /workspace/service.yaml >/workspace/tmp.yaml && mv /workspace/tmp.yaml /workspace/service.yaml
